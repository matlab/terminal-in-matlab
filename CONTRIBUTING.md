...
- **Open an issue:** Start by [creating an issue](https://github.com/matlab/terminal-in-matlab/issues). That will start a conversation with the maintainer. When you are creating a bug report, please include as many details as possible. Please remember that other people do not have your background or understanding of the issue; make sure you are clear and complete in your description.
...
**Thankk you for contributing, and we look forward to your issues and pull requests!**
